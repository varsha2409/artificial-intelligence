...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any([~effect in actionA.effects for effect in actionB.effects])
    ...
    def _interference(self, actionA, actionB):
        ...
        """
        # TODO: implement this function
        return any([~effect in actionB.preconditions for effect in actionA.effects])
...
class PlanningGraph:
    ...
    def h_setlevel(self):
        ...
        while not self._is_leveled:
            ...
            if all([(goal in layer) for goal in self.goal]) and not any(layer.is_mutex(g1, g2) for g1, g2 in combinations(self.goal, 2)):
                return level
            self._extend()
            level += 1
        return -1
